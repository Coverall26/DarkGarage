        ...
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={() => {
              setError(false);
              setLoading(true);
              fetch(`/api/ai/insights?contactId=${contactId}`)
                .then((res) => {
  ...
  return (
    <div className="rounded-md border border-purple-200 bg-purple-50/50 p-3 dark:border-purple-800 dark:bg-purple-950/20">
      <div className="flex items-center justify-between mb-1.5">
        ...
        <span className={`inline-flex items-center rounded-full px-1.5 py-0.5 text-xs font-medium ${typeBadgeColors[insight.type] || typeBadgeColors.action}`}>
          {insight.type}
        </span>
      </div>
