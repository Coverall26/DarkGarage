...
import SignSuiteNdaSection from "./signsuite-nda-section";
...
export default function AccessForm({
  ...
  requireSignSuiteNda?: boolean;
  signSuiteNdaDocumentId?: string | null;
}) {
  ...
  const isFormValid = () => {
    ...
    if (requireSignSuiteNda && !data.hasCompletedSignSuiteNda) return false;
      ...
      <div className="flex flex-1 flex-col px-6 pb-12 pt-8 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-md">
          <form className="space-y-4" onSubmit={onSubmitHandler} translate="no">
            ...
            {requireSignSuiteNda && signSuiteNdaDocumentId && linkId ? (
              <SignSuiteNdaSection
                {...{ data, setData, brand }}
                linkId={linkId}
                signSuiteNdaDocumentId={signSuiteNdaDocumentId}
              />
            ) : null}
