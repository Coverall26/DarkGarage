...
export async function createVisitorMagicLink({
  ...
  try {
    ...
    logger.error("Error creating magic link", { module: "visitor-magic-link", error: String(error) });
    return null;
  }
}
...
export async function verifyVisitorMagicLink({
  ...
  try {
    ...
    logger.error("Error verifying magic link", { module: "visitor-magic-link", error: String(error) });
    return false;
  }
}
