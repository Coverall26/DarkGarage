                  ...
                  {wizardStep === 1 && (
                    <div className="space-y-4 py-4">
                      <div className="space-y-2">
                        ...
                        <Select
                          value={actionType}
                          onValueChange={(v) => setActionType(v as "capital_call" | "distribution")}
                        >
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                    ...
                    <div className="space-y-4 py-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(v) => setAllocationType(v as "equal" | "pro_rata")}
                        >
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                    ...
                    <div className="py-4 space-y-4">
                      ...
                      <div className="border rounded-lg overflow-hidden">
                        <Table>
                          ...
                          <TableBody>
                            {actionResult.allocations?.slice(0, 5).map((a: { investorId: string; investorName: string; allocation: number; percentage: number }) => (
