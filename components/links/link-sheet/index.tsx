...
export type DEFAULT_LINK_TYPE = {
  ...
  enableSignSuiteNda: boolean; // SignSuite NDA gate
...
export default function LinkSheet({
  ...
  const applyPreset = (presetId: string) => {
    ...
    setData((prev) => {
      ...
      return {
        ...
        enableSignSuiteNda: preset.enableSignSuiteNda || prev.enableSignSuiteNda,
        signSuiteNdaDocumentId: preset.signSuiteNdaDocumentId || prev.signSuiteNdaDocumentId,
  ...
  const handleSubmit = async (event: React.FormEvent, shouldPreview: boolean = false) => {
