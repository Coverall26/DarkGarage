...
export async function getInvestorDocument(path: string): Promise<Buffer | null> {
  try {
    ...
    logger.error("Error downloading investor document", { module: "investor-storage", path, error: String(error) });
    return null;
  }
}
...
export async function getInvestorDocumentUrl(path: string): Promise<string | null> {
  try {
    ...
    logger.error("Error getting investor document URL", { module: "investor-storage", path, error: String(error) });
    return null;
  }
}
...
export async function getInvestorDocumentSignedUrl(
  ...
  try {
    ...
    logger.error("Error getting signed URL", { module: "investor-storage", path, error: String(error) });
    return null;
  }
}
...
export async function listInvestorDocuments(investorId: string): Promise<string[]> {
  try {
    ...
    logger.error("Error listing investor documents", { module: "investor-storage", investorId, error: String(error) });
    return [];
  }
}
...
export async function deleteInvestorDocument(path: string): Promise<boolean> {
  try {
    ...
    logger.error("Error deleting investor document", { module: "investor-storage", path, error: String(error) });
    return false;
  }
}
...
export async function copyInvestorDocument(
  ...
  try {
    ...
    logger.error("Error copying investor document", { module: "investor-storage", sourcePath, destPath, error: String(error) });
    return false;
  }
}
