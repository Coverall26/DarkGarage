/**
 * PHASE 2 — SaaS Billing Cancellation Modal
 *
 * Multi-step cancellation flow inherited from Papermark SaaS billing.
 * Steps: pause-offer → reason → retention/schedule/feedback → confirm → final-feedback.
 * Calls /api/teams/[teamId]/billing/cancellation-feedback.
 *
 * This is part of the ee/stripe SaaS billing system (team-scoped),
 * separate from CRM billing (org-scoped, at lib/stripe/crm-products.ts).
 *
 * Phase 2: Unify SaaS + CRM billing into a single subscription model.
 * Sub-components in this directory: confirm, feedback, pause, retention, schedule, reason-base.
 */
