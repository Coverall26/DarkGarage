    ...
    <div className={className}>
      ...
      >
        <input
          ...
          className="flex-1 border-none bg-transparent text-base text-neutral-900 placeholder-neutral-400 focus:outline-none focus:ring-0 sm:text-sm"
        />
        {showCalendarIcon && (
          <input
            type="datetime-local"
            ...
            className="min-h-[44px] min-w-[44px] border-none bg-transparent text-neutral-500 focus:outline-none focus:ring-0 sm:text-sm"
          />
        )}
      </div>
    </div>
