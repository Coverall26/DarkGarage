// STATUS: Phase 2 — SaaS billing cancellation wizard base modal.
// Part of the multi-step cancellation flow orchestrated by cancellation-modal.tsx.
// Not used in CRM billing (see app/admin/settings/sections/billing-crm.tsx for active billing).
