 ...
 *   BUSINESS: Unlimited contacts/signers, 75 e-sigs/mo, 10 templates, analytics
...
export type CrmSubscriptionTier = "FREE" | "CRM_PRO" | "BUSINESS" | "FUNDROOM";
...
export interface CrmTierLimits {
  ...
  signatureTemplateLimit: number | null; // null = unlimited
  hasKanban: boolean;
