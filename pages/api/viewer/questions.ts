    ...
    try {
      ...
      for (const adminEmail of adminEmails) {
        try {
          ...
          logger.error("Failed to send email notification", { module: "viewer", metadata: { error: (emailError as Error).message } });
        }
      }
      ...
      logger.error("Error creating question", { module: "viewer", metadata: { error: (error as Error).message } });
