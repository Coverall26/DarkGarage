...
const ViewerBreadcrumbItem = ({
  ...
  folder: { id: string; name: string; hierarchicalIndex?: string | null; [key: string]: unknown };
...
export default function DataroomViewer({
  ...
  dataroom: {
    id: string;
    name?: string;
    // eslint-disable-next-line @typescript-eslint/no-explicit-any -- documents are cast to DataroomDocument[] internally; callers pass varying nested shapes from Prisma
    documents: DataroomDocument[] | any[];
    folders: DataroomFolder[];
