    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <SummaryCard title="Company" icon={Building2} step={0} onEdit={onGoToStep}>
          ...
          <SummaryRow
            label="Entity"
            value={ENTITY_TYPE_LABELS[data.entityType] || data.entityType || "Not set"}
          />
          <SummaryRow
            label="EIN"
        ...
        {/* Investor Onboarding (skip for DATAROOM_ONLY) */}
        {!isDataroomOnly && (
          <SummaryCard title="Investor Onboarding" icon={Users} step={6} onEdit={onGoToStep}>
            <SummaryRow
              label="GP Approval"
        ...
        >
          ...
          <div className="mt-1 space-y-0.5">
            {["SignSuite", "Secure Storage", "Audit Logging", "Email (Resend)", "Wire Transfer"].map((name) => (
      ...
      {!isDataroomOnly && (
        <div className="rounded-lg border-2 border-[#0066FF]/30 bg-blue-50/50 p-5 dark:bg-blue-950/20 dark:border-blue-800">
          ...
          <ul className="text-xs text-gray-600 dark:text-gray-400 space-y-1">
            ...
            <li className="flex items-center gap-1.5">
              <Check size={12} className="text-emerald-500" /> Investor onboarding
          ...
          {[
            ...
            ...(!isDataroomOnly
              ? [
                  ...
                  { label: "Investor onboarding settings", done: true },
                ]
              : []),
