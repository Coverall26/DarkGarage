...
export const sendEmail = async ({
  ...
  if (!resend) {
    logger.error("RESEND_API_KEY is not set — cannot send emails", { module: "resend" });
...
export const sendOrgEmail = async ({
  ...
  try {
    ...
    logger.warn("Failed to resolve org email, using platform default", { module: "resend", teamId, error: String(e) });
  }
