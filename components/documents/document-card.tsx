...
export default function DocumentsCard({
  ...
  const handleButtonClick = (event: React.MouseEvent, documentId: string) => {
    ...
    toast.promise(
      fetch(`/api/teams/${teamInfo?.currentTeam?.id}/documents/${documentId}`, {
        ...
        mutate(
          ...
          (currentData: DocumentWithLinksAndLinkCountAndViewCount[] | { documents: DocumentWithLinksAndLinkCountAndViewCount[] } | undefined) => {
  ...
  const handleDuplicateDocument = async (event: React.MouseEvent) => {
    event.stopPropagation();
    event.preventDefault();
