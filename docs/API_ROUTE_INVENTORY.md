...
| GET | `app/api/admin/fund/[fundId]` | YES | NO | team | Fund detail for admin |
| GET | `app/api/admin/fund/[fundId]/pending-actions` | YES | NO | team | Pending action counts (wires, docs, reviews) |
| GET | `app/api/admin/fund/[fundId]/pending-details` | YES | NO | team | Pending action details with inline resolution |
| GET,POST,PATCH,DELETE | `app/api/admin/fund/[fundId]/pricing-tiers` | YES | NO | team | CRUD pricing tiers for fund |
...
| GET | `app/api/admin/fund/list` | YES | YES | admin | List all funds for admin (id, name, teamId) |
| GET,POST | `app/api/admin/fund/[fundId]/threshold-settings` | YES | YES | admin | Get/update fund threshold & economics |
