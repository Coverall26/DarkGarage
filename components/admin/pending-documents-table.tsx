...
const STATUS_COLORS: Record<string, string> = {
  PENDING_REVIEW: statusBadgeClasses.pendingReview,
  APPROVED: statusBadgeClasses.docApproved,
  REJECTED: statusBadgeClasses.docRejected,
  REVISION_REQUESTED: statusBadgeClasses.revisionRequested,
};
              ...
              <TableRow key={doc.id}>
                ...
                <TableCell>
                  ...
                  {doc.uploadSource === "GP_UPLOADED_FOR_LP" && (
                    <Badge variant="secondary" className={`ml-1 text-xs ${statusBadgeClasses.gpUpload}`}>
                      GP Upload
                    </Badge>
                  )}
                  {doc.uploadSource === "LP_UPLOADED_EXTERNAL" && (
                    <Badge variant="secondary" className={`ml-1 text-xs ${statusBadgeClasses.externalUpload}`}>
                      External
                    </Badge>
                  )}
          ...
          <div className="space-y-4 py-4">
            {reviewingDoc?.lpNotes && (
              <div className="p-3 bg-muted rounded-lg">
                <p className="text-sm font-medium mb-1">Investor Notes:</p>
