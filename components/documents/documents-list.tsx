...
// DataroomFolderWithCount no longer needed - draggedFolder uses FolderWithCount only
...
export function DocumentsList({
  ...
  const { setDeleteModalOpen, setFolderToDelete, DeleteFolderModal } =
    useDeleteFolderModal(teamInfo ? { currentTeam: teamInfo.currentTeam ?? undefined } : null);
  ...
  const handleDragForType = useCallback(
    <T extends { id: string }>(
      itemId: string,
      items: T[] | undefined,
      setDraggedItem: React.Dispatch<React.SetStateAction<T | null>>,
