...
export default async function handler(
  ...
  try {
    ...
    const whereClause: Prisma.SignatureAuditLogWhereInput = {};
    ...
    const createdAtFilter: Prisma.DateTimeFilter<"SignatureAuditLog"> = {};
    ...
    if (exportFormat === "pdf") {
      ...
      html += `
          ...
          <div class="footer">
            ...
            <p>Report generated by SignSuite - ${format(new Date(), "yyyy-MM-dd'T'HH:mm:ss'Z'")}</p>
          </div>
        </body>
        </html>
      `;
    ...
    logger.error("Export audit error", { module: "teams", metadata: { error: (error as Error).message } });
