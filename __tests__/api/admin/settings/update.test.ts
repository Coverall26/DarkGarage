 ...
 * linkDefaults, investorOnboarding (alias: lpOnboarding), notifications, audit.
...
describe("Settings Update API (/api/admin/settings/update)", () => {
  ...
  // --- Section: notifications (via investorOnboarding) ---
  ...
  it("updates investor onboarding settings with document templates", async () => {
