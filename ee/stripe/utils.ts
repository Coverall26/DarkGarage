...
export function getPlanFromPriceId(
  ...
  if (!plan) {
    ...
    logger.error("Plan not found for priceId", { module: "stripe", metadata: { priceId, isOldAccount: String(isOldAccount), env } });
...
export function isNewCustomer(
  ...
  try {
    ...
    logger.error("An error occurred", { module: "stripe", metadata: { error: (error as Error).message } });
  }
