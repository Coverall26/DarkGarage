...
export async function createEmailDomain(
  ...
  if (error) {
    logger.error("Resend create domain error", { module: "domain-service", error: String(error) });
...
export async function verifyEmailDomain(teamId: string): Promise<DomainStatus> {
  ...
  if (error) {
    logger.error("Resend verify error", { module: "domain-service", error: String(error) });
...
export async function getEmailDomainStatus(teamId: string): Promise<DomainStatus> {
  ...
  if (error) {
    logger.error("Resend get domain error", { module: "domain-service", error: String(error) });
...
export async function removeEmailDomain(teamId: string): Promise<void> {
  ...
  try {
    ...
    logger.error("Resend remove error (continuing)", { module: "domain-service", error: String(e) });
