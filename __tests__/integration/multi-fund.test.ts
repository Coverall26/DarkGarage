...
describe("Multi-Fund Features", () => {
  ...
  describe("Per-Fund Dashboard API", () => {
    it("returns fund details with aggregates and investors", async () => {
      ...
      const fundDetailMod = await import("@/app/api/admin/fund/[fundId]/route");
      const fundDetailHandler = wrapAppRouteHandler(fundDetailMod, { fundId: "fund-1" });
    ...
    it("returns 404 for non-existent fund", async () => {
      ...
      const fundDetailMod = await import("@/app/api/admin/fund/[fundId]/route");
      const fundDetailHandler = wrapAppRouteHandler(fundDetailMod, { fundId: "nonexistent-fund" });
