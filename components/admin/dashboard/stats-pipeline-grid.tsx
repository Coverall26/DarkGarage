    ...
    <Card className="shadow-sm hover:shadow-md transition-shadow duration-200">
      <CardContent className="pt-4 pb-3 px-4">
        <div className="flex items-center gap-2 mb-1.5">
          <div className="h-7 w-7 rounded-lg flex items-center justify-center" style={{ backgroundColor: iconBg }}>
      ...
      <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        {mode === "DATAROOM_ONLY" && (
          <>
            <StatCard
              icon={Users}
              iconBg={SUITE_COLORS.pipelineiq}
              label="Leads"
                ...
                {PIPELINE_STAGES.map((stage) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="absolute -top-9 left-1/2 -translate-x-1/2 bg-foreground text-background text-xs font-medium px-2 py-1 rounded-md opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-10">
                        {stage.label}: {count}
                      </div>
                    </div>
                  );
