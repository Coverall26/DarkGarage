...
export default async function handler(
  ...
  try {
    ...
    logger.error("Signature API error", { module: "signature", metadata: { error: (error as Error).message } });
