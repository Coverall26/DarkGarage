...
export class ReplitStorageProvider implements StorageProvider {
  ...
  async get(
    ...
    try {
      ...
      logger.error("Error downloading from Replit storage", { module: "replit-provider", key, error: String(error) });
      return null;
    }
  }
  ...
  async delete(key: string): Promise<boolean> {
    try {
      ...
      logger.error("Error deleting from Replit storage", { module: "replit-provider", key, error: String(error) });
      return false;
    }
  }
  ...
  async list(options?: StorageListOptions): Promise<StorageListResult> {
    try {
      ...
      logger.error("Error listing Replit storage", { module: "replit-provider", error: String(error) });
      return { keys: [], isTruncated: false };
    }
  }
