...
describe('Phase 2: Jest Automation - Admin Routes', () => {
  ...
  describe('Admin Fund Management API', () => {
    it('GET /api/admin/fund - should list all funds', () => {
      const request = {
        method: 'GET',
        endpoint: '/api/admin/fund?teamId=team-1',
        response: {
          status: 200,
          funds: [
    ...
    it('POST /api/admin/fund - should create new fund', () => {
      const request = {
        method: 'POST',
        endpoint: '/api/admin/fund',
        body: {
    ...
    it('PATCH /api/admin/fund/:id - should update fund settings', () => {
      const request = {
        method: 'PATCH',
        endpoint: '/api/admin/fund/fund-1',
    ...
    it('GET /api/admin/fund/:id/dashboard - should get fund dashboard', () => {
      const request = {
        method: 'GET',
        endpoint: '/api/admin/fund/fund-1/dashboard',
        response: {
          status: 200,
          dashboard: {
            totalCommitment: 5000000,
