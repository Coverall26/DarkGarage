...
const additionalEndpoints = [
  ...
  // Billing routes migrated to App Router (app/api/teams/[teamId]/billing/)
  // Documents index migrated to App Router (app/api/teams/[teamId]/documents/route.ts)
  'pages/api/teams/[teamId]/documents/search',
  // Datarooms index migrated to App Router (app/api/teams/[teamId]/datarooms/route.ts)
  ...
  // Links routes migrated to App Router (app/api/links/)
