...
export class CryptoService {
  ...
  constructor(encryptionKey?: string) {
    ...
    if (isValidHexKey) {
      ...
      logger.warn("CryptoService: Using password-based key derivation (DEVELOPMENT ONLY). For production, set STORAGE_ENCRYPTION_KEY to a 64-character hex key.", { module: "crypto-service" });
    }
  }
