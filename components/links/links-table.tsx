...
import { BarChart, ChevronDown, MoreHorizontal } from "../shared/icons";
...
export default function LinksTable({
  ...
  const handleEditLink = (link: LinkWithViews) => {
    setSelectedLink({
      ...
      enableSignSuiteNda: link.enableSignSuiteNda ?? false,
      signSuiteNdaDocumentId: link.signSuiteNdaDocumentId ?? null,
  ...
  const handlePermissionsSave = async (permissions: Record<string, { view: boolean; download: boolean; itemType: string }> | null) => {
