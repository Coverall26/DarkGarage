...
describe('Admin Endpoints', () => {
  ...
  test('GET /api/admin/fund/:id/pricing-tiers', async () => {
    const result = await testPagesHandler('app/api/admin/fund/[fundId]/pricing-tiers/route', 'GET', undefined, { fundId: 'test-fund-id' });
    expect(result.status).not.toBe(-2);
  });
});
...
// Migrated to App Router — tested in: app/api/teams/[teamId]/billing/
// ============================================================
...
describe('Teams Documents Endpoints', () => {
  ...
  // documents/index migrated to App Router — tested in: app/api/teams/[teamId]/documents/route.ts
  ...
  // documents/[id]/index migrated to App Router — tested in: app/api/teams/[teamId]/documents/[id]/route.ts
...
describe('Teams Dataroom Endpoints', () => {
  ...
  // datarooms/index migrated to App Router — tested in: app/api/teams/[teamId]/datarooms/route.ts

  // datarooms/[id]/index migrated to App Router — tested in: app/api/teams/[teamId]/datarooms/[id]/route.ts

  test('GET /api/teams/:teamId/datarooms/:id (subdirectory routes)', async () => {
    // Remaining dataroom sub-routes still in Pages Router
...
// __tests__/integration/fund-settings-economics.test.ts (legacy — now at /api/admin/fund/[fundId]/threshold-settings)

// ============================================================
// CATEGORY 14: Links Endpoints
// Migrated to App Router — tested in: app/api/links/
// ============================================================
...
describe('API Endpoint Status Report', () => {
  const allEndpoints: Array<{
    ...
    // Teams billing — migrated to App Router (app/api/teams/[teamId]/billing/)
    // Teams documents/index — migrated to App Router (app/api/teams/[teamId]/documents/route.ts)
    { path: 'pages/api/teams/[teamId]/documents/search', method: 'GET', category: 'Documents', query: { teamId: 'test-team-id', q: 'test' } },
    // Teams datarooms/index — migrated to App Router (app/api/teams/[teamId]/datarooms/route.ts)
    // Teams signature
