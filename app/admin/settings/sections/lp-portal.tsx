...
export function LPPortalSettingsSection({
  ...
  return (
    <div className="space-y-3">
      <ToggleRow
        label="Investor Document Upload"
        description="Allow investors to upload documents directly through the portal"
        checked={form.allowExternalDocUpload}
        onChange={(v) => update({ allowExternalDocUpload: v })}
      />
      <ToggleRow
        label="GP Upload on Behalf of Investor"
      ...
      <ToggleRow
        ...
        description="All investor submissions require explicit GP approval before advancing"
