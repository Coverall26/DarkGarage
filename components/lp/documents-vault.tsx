...
const DOC_TYPE_CONFIG: Record<string, { icon: LucideIcon; color: string; label: string }> = {
                  ...
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {doc.isClientEncrypted && (
                          <span className="shrink-0 inline-flex items-center gap-1 px-1.5 py-0.5 bg-emerald-500/20 text-emerald-400 rounded text-xs font-medium">
