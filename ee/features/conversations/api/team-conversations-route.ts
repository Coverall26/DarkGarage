...
const routeHandlers = {
  ...
  "GET /": async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    try {
      ...
      logger.error("Error getting dataroom conversations", { module: "conversations", metadata: { error: (error as Error).message } });
  ...
  "POST /": async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    try {
      ...
      logger.error("Error creating conversation", { module: "conversations", metadata: { error: (error as Error).message } });
      return res.status(500).json({ error: "Internal server error" });
    }
  },
  ...
  "GET /summaries": async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    try {
      ...
      logger.error("Error in conversations/summaries API", { module: "conversations", metadata: { error: (error as Error).message } });
      return res.status(500).json({ error: "Internal server error" });
    }
  },
  ...
  "GET /[conversationId]": async (
    ...
    try {
      ...
      logger.error("Error getting conversation", { module: "conversations", metadata: { error: (error as Error).message } });
      return res.status(500).json({ error: "Internal server error" });
    }
  },
  ...
  "POST /[conversationId]/read": async (
    ...
    try {
      ...
      logger.error("Error marking conversation as read", { module: "conversations", metadata: { error: (error as Error).message } });
      return res.status(500).json({ error: "Internal server error" });
    }
  },
  ...
  "POST /[conversationId]/messages": async (
    ...
    try {
      ...
      logger.error("Error adding message", { module: "conversations", metadata: { error: (error as Error).message } });
      return res.status(500).json({ error: "Internal server error" });
    }
  },
  ...
  "PUT /[conversationId]/messages/[messageId]/read": async (
    ...
    try {
      ...
      logger.error("Error marking message as read", { module: "conversations", metadata: { error: (error as Error).message } });
      return res.status(500).json({ error: "Internal server error" });
    }
  },
  ...
  "PATCH /[conversationId]/toggle": async (
    ...
    try {
      ...
      logger.error("Error toggling dataroom conversations", { module: "conversations", metadata: { error: (error as Error).message } });
      return res.status(500).json({ error: "Internal server error" });
    }
  },
  ...
  "DELETE /[conversationId]": async (
    ...
    try {
      ...
      logger.error("Error deleting conversation", { module: "conversations", metadata: { error: (error as Error).message } });
...
export async function handleRoute(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    logger.error("API Error", { module: "conversations", metadata: { error: (error as Error).message } });
