...
import { DistributionsTab } from "@/components/admin/distributions";
import { FundMetricsCard } from "@/components/admin/fund-detail/fund-metrics-card";
...
export function FundOverviewTab({ fund, formatCurrency }: FundOverviewTabProps) {
  ...
  return (
    <>
      ...
      <div className="mb-6">
        <FundMetricsCard fundId={fund.id} teamId={fund.teamId} />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="text-center py-6 space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1 max-w-[280px] mx-auto">
                    Capital calls let you request committed capital from your investors on a schedule. Create calls, track responses, and manage drawdowns.
                  </p>
                </div>
                <button
                  disabled
                ...
                <p className="text-xs text-muted-foreground/50">Coming in Phase 2</p>
              </div>
            ) : (
        ...
        <DistributionsTab fundId={fund.id} teamId={fund.teamId} />
      </div>
