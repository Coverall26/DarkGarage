> **⚠️ DEPRECATION NOTICE (March 2, 2026)**
> This file is a **historical reference artifact** — it was the original JSX prototype used to guide the GP/LP wizard builds.
> The production implementations have since diverged significantly and live at:
> - **GP Setup Wizard (9 steps):** `app/admin/setup/` — 14 files, ~4,500 lines (see CLAUDE.md § GP Setup Wizard)
> - **LP Onboarding (9 steps):** `app/lp/onboard/page-client.tsx` + `components/onboarding/` — ~2,500 lines
>
> **For the latest interactive demo artifact, see:** `docs/FundRoom_v5_Demo.jsx` (~1,685 lines) — polished single-file React JSX demo with v3 naming, 4 CRM tiers, Lara AI, WCAG 2.1 AA accessibility, and 15 documented sections.
>
> **Do NOT use this file as a source of truth for field names, step order, or component structure.**
> Canonical references: `CLAUDE.md` (implementation status), `prisma/schema.prisma` (field names), and the source files above.

---

# GP/LP Production ready React Wizard (ARCHIVED)
...
7.	Integrations — Active defaults (SignSuite, S3, audit, Resend), Phase 2/3 integrations, compliance settings
...
2.	NDA — Full NDA text + SignSuite e-signature
...
1.	Reference the JSX code below (note: `components/showcase/fundroom-wizard.jsx` has been deleted — production code is in `app/admin/setup/`)
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {[
            { icon: FileSignature, label: "SignSuite", desc: "Native e-signature. Zero external API cost." },
    ...
    <div className="space-y-6">
      ...
      <Card className="bg-blue-50/50 border-blue-200">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h4 className="font-semibold text-gray-900 text-sm">E-sign with SignSuite</h4>
      ...
      <Card className="bg-blue-50/50 border-blue-200">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-500 mt-1 mb-3">E-sign with SignSuite, or upload externally signed documents.</p>
