...
const routeHandlers = {
  ...
  "POST /": async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    try {
      ...
      logger.error("Error publishing FAQ", { module: "conversations", metadata: { error: (error as Error).message } });
  ...
  "GET /": async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    try {
      ...
      logger.error("Error fetching FAQs", { module: "conversations", metadata: { error: (error as Error).message } });
      return res.status(500).json({ error: "Internal server error" });
    }
  },
  ...
  "PUT /[faqId]": async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    try {
      ...
      logger.error("Error updating FAQ", { module: "conversations", metadata: { error: (error as Error).message } });
      return res.status(500).json({ error: "Internal server error" });
    }
  },
  ...
  "DELETE /[faqId]": async (req: NextApiRequest, res: NextApiResponse) => {
    ...
    try {
      ...
      logger.error("Error deleting FAQ", { module: "conversations", metadata: { error: (error as Error).message } });
      return res.status(500).json({ error: "Internal server error" });
    }
  },
};
