...
describe("LP Subscribe API", () => {
  ...
  describe("Authentication", () => {
    it("should reject unauthenticated requests", async () => {
      ...
      const { req, res } = createMocks<NextApiRequest, NextApiResponse>({
        method: "POST",
        body: { fundId: "00000000-0000-4000-a000-000000000001", amount: "100000" },
      });
  ...
  describe("Input Validation", () => {
    ...
    it("should require amount", async () => {
      const { req, res } = createMocks<NextApiRequest, NextApiResponse>({
        method: "POST",
        body: { fundId: "00000000-0000-4000-a000-000000000001" },
      });
    ...
    it("should reject subscription to different fund", async () => {
      mockPrismaUser.findUnique.mockResolvedValue({
        ...
        investorProfile: {
          ...
          ndaSigned: true,
          accreditationStatus: "SELF_CERTIFIED",
          fundId: "00000000-0000-4000-a000-000000000099", // Associated with different fund
        },
      });
  ...
  describe("Amount Validation", () => {
    ...
    it("should reject invalid amount (NaN)", async () => {
      ...
      const { req, res } = createMocks<NextApiRequest, NextApiResponse>({
        method: "POST",
        body: { fundId: "00000000-0000-4000-a000-000000000001", amount: "not-a-number" },
      });
    ...
    it("should reject zero or negative amount", async () => {
      ...
      const { req, res } = createMocks<NextApiRequest, NextApiResponse>({
        method: "POST",
        body: { fundId: "00000000-0000-4000-a000-000000000001", amount: "0" },
      });
    ...
    it("should reject amount below minimum investment", async () => {
      ...
      const { req, res } = createMocks<NextApiRequest, NextApiResponse>({
        method: "POST",
        body: { fundId: "00000000-0000-4000-a000-000000000001", amount: "50000" },
      });
  ...
  describe("Tiered Subscription (Non-Flat Mode)", () => {
    ...
    it("should require units for tiered subscription", async () => {
      ...
      const { req, res } = createMocks<NextApiRequest, NextApiResponse>({
        method: "POST",
        body: { fundId: "00000000-0000-4000-a000-000000000001", amount: "100000" }, // No units
      });
    ...
    it("should reject when not enough units available", async () => {
      ...
      const { req, res } = createMocks<NextApiRequest, NextApiResponse>({
        method: "POST",
        body: { fundId: "00000000-0000-4000-a000-000000000001", amount: "100000", units: "100" }, // Want 100, only 10 available
      });
