...
export function LPHeader() {
  ...
  return (
    <nav className="bg-black/60 backdrop-blur-md border-b border-gray-800/50 sticky top-0 z-40 shadow-lg shadow-black/10" aria-label="Investor portal navigation">
