    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50">
        <div className="mb-8 text-center">
          <h2 className="text-xl font-bold text-gray-900">SignSuite</h2>
        ...
        <div className="max-w-md rounded-lg bg-white p-8 text-center shadow-lg">
          ...
          {declineReason && (
            <div className="mt-4 rounded-md bg-gray-50 p-3 text-left">
              ...
              <p className="mt-1 text-sm text-gray-700">{declineReason}</p>
            </div>
          )}
          ...
          <div className="mx-auto flex max-w-5xl flex-col gap-3 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:py-4">
            <div className="flex items-center gap-2 sm:gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-bold text-gray-900 sm:text-base">SignSuite</span>
              </div>
                                    ...
                                    {field.type === "SIGNATURE" && !isSigned && (
                                      <div className="w-full h-full flex items-center justify-center">
                                        <div className="flex flex-col items-center gap-0.5">
                                          ...
                                          <span className="text-xs font-medium text-blue-700">Sign here</span>
                                        </div>
                                      </div>
                                    )}
                                  </div>
      ...
      <AlertDialog open={showDeclineDialog} onOpenChange={setShowDeclineDialog}>
        <AlertDialogContent>
          ...
          <div className="rounded-md bg-amber-50 p-3 text-sm text-amber-800">
            The document sender will be notified of your decision and the reason
            you provide.
          </div>
          <div className="py-2">
