...
export function DashboardHeader() {
  ...
  useEffect(() => {
    ...
    fetch("/api/admin/session-info", { signal: controller.signal })
      ...
      .catch((e) => { if (e?.name !== "AbortError") logger.error("Failed to load session info", { module: "dashboard-header", metadata: { error: (e as Error).message } }); });
      ...
      <div className="flex-1 flex justify-center" ref={searchRef}>
        <div className="relative w-full max-w-md">
          ...
          >
            ...
            <kbd className="hidden lg:inline-flex ml-auto text-xs px-1.5 py-0.5 rounded bg-muted text-muted-foreground border border-border">
              ⌘K
            </kbd>
          </button>
          {searchOpen && (
      ...
      <div className="flex items-center gap-1.5 flex-shrink-0">
        ...
        <div className="relative" ref={notifRef}>
          ...
          >
            ...
            {pendingCount > 0 && (
              <span className="absolute -top-0.5 -right-0.5 h-4 min-w-[16px] px-1 rounded-full bg-red-500 text-white text-xs font-bold flex items-center justify-center font-mono">
            ...
            <div className="absolute right-0 top-full mt-1 w-72 rounded-lg border border-border bg-background shadow-lg z-50">
              <div className="p-3 border-b border-border">
                <div className="flex items-center justify-between">
                  ...
                  {pendingCount > 0 && (
                    <Badge variant="secondary" className="text-xs h-5 bg-amber-100 text-amber-800 dark:bg-amber-900/50 dark:text-amber-300">
