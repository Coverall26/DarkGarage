...
// App Router equivalent: app/api/esign/envelopes/route.ts
// See docs/PAGES-ROUTER-MIGRATION.md
// DEPRECATED: Migrate to App Router /api/esign/* routes. See docs/SIGNATURE-API-MAP.md
// Canonical equivalent: POST /api/esign/envelopes + POST /api/esign/envelopes/[id]/send
...
export default async function handler(
  ...
  try {
    ...
    logger.error("Create document error", { module: "signature", metadata: { error: (error as Error).message } });
