/**
 * SignSuite - Self-hosted E-Signature Provider
 *
 * Unlike external providers (DocuSign, DropboxSign), SignSuite is self-hosted
...
export class FundRoomSignProvider implements EsignProvider {
  ...
  verifyWebhookSignature(payload: string, signature: string): boolean {
    if (!this.config.webhookSecret) {
      logger.warn("E-sign webhook secret not configured - signature verification skipped", { module: "fundroom-sign" });
      return false;
    }
