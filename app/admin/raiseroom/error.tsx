...
export default function RaiseRoomError({
  error,
  reset,
}: {
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0A1628] px-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-gray-400 mb-2 text-sm">
          Something went wrong while loading capital raise management. This has been reported and our team is looking into it.
        </p>
        {error.digest && (
