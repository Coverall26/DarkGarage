    ...
    <Card className="border-amber-200/80 dark:border-amber-800/40 bg-amber-50/40 dark:bg-amber-950/15 shadow-sm">
      <CardHeader className="pb-2 pt-4">
        <CardTitle className="text-sm flex items-center gap-2">
          ...
          Action Required
          <Badge variant="secondary" className="bg-amber-100 text-amber-800 dark:bg-amber-900/50 dark:text-amber-300 text-xs font-bold font-mono h-5 px-1.5 ml-0.5">
          ...
          {pendingActions.awaitingWire > 0 && (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-muted-foreground">awaiting wire</p>
              </div>
