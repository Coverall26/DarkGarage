...
export default async function handle(
  ...
  try {
    ...
    const returnData = {
      ...
      pages: undefined as Record<string, unknown>[] | undefined,
      file: undefined as string | undefined,
      sheetData: undefined as Record<string, unknown> | undefined,
    };
    ...
    logger.error("Preview data error", { module: "teams", metadata: { error: (error as Error).message } });
    const errMsg = error instanceof Error ? error.message : String(error);
    const errStack = error instanceof Error ? error.stack : undefined;
    logger.error("Error message", { module: "teams", metadata: { error: errMsg } });
    logger.error("Error stack", { module: "teams", metadata: { stack: errStack } });
