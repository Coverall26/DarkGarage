...
| GET, POST, PATCH, DELETE | `/api/admin/fund/{id}/pricing-tiers` | Manage pricing tiers |
...
Organization-scoped CRM subscription tiers: FREE ($0), CRM_PRO ($29/mo), FUNDROOM ($79/mo), AI_CRM (+$49/mo add-on).
