...
const STATUS_COLORS: Record<string, string> = {
  PROSPECT: "bg-gray-100 text-gray-700 dark:bg-gray-900/30 dark:text-gray-400",
  LEAD: "bg-sky-100 text-sky-700 dark:bg-sky-900/30 dark:text-sky-400",
  OPPORTUNITY: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400",
  ...
  NDA_SIGNED: "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400",
  ACCREDITED: "bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400",
  COMMITTED: "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400",
...
const SOURCE_LABELS: Record<string, string> = {
  ...
  INVESTOR_ONBOARDING: "Investor Onboard",
...
const SOURCE_COLORS: Record<string, string> = {
  DATAROOM_VIEW: "bg-sky-100 text-sky-700 dark:bg-sky-900/30 dark:text-sky-400",
  INVESTOR_ONBOARDING: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400",
  DEAL_INTEREST: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400",
  MANUAL_ENTRY: "bg-gray-100 text-gray-700 dark:bg-gray-900/30 dark:text-gray-400",
  MARKETPLACE_WAITLIST: "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400",
  SIGNATURE_EVENT: "bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400",
  BULK_IMPORT: "bg-gray-100 text-gray-600 dark:bg-gray-900/30 dark:text-gray-500",
            ...
            return (
              ...
              >
                ...
                <td className="hidden px-3 py-3 lg:table-cell">
                  <Badge
                    variant="secondary"
                    className={`text-xs ${SOURCE_COLORS[contact.source] || ""}`}
                  >
