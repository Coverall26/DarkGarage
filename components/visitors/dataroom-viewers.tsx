...
/** Shape of a viewer returned by the dataroom viewers API */
interface DataroomViewerItem {
  id: string;
  teamId: string;
  email: string | null;
  verified: boolean;
...
export default function DataroomViewersTable({
  ...
  const { viewers } = useDataroomViewers({ dataroomId }) as { viewers: DataroomViewerItem[] | undefined; loading: boolean; error: unknown };
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="focus:outline-none">
                              <p className="flex items-center gap-x-2 overflow-visible text-sm font-medium text-gray-800 dark:text-gray-200">
                                {viewer.email ? (
                                  <>
                                    {viewer.viewerName || viewer.email}{" "}
                                    <CopyButton
                                      value={viewer.email}
