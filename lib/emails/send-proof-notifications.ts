...
export async function sendProofReceivedNotification(
  ...
  try {
    ...
    logger.error("Failed to send proof received notification", { module: "send-proof-notifications", error: String(error), investmentId });
  }
}
...
export async function sendProofVerifiedNotification(
  ...
  try {
    ...
    logger.error("Failed to send proof verified notification", { module: "send-proof-notifications", error: String(error), investmentId });
  }
}
...
export async function sendProofRejectedNotification(
  ...
  try {
    ...
    logger.error("Failed to send proof rejected notification", { module: "send-proof-notifications", error: String(error), investmentId });
  }
}
