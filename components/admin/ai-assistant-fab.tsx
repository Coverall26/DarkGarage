...
function getContextHint(pathname: string): ContextHint {
  ...
  if (pathname.startsWith("/admin/raise-crm") || pathname.startsWith("/admin/outreach")) {
    return {
      page: "pipelineiq",
      label: "PipelineIQ & Outreach",
      suggestions: [
  ...
  if (pathname.startsWith("/admin/settings")) {
    return {
      ...
      suggestions: [
        ...
        "What are the investor visibility settings?",
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-border flex-shrink-0">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">{contextHint.label} context</p>
              </div>
            </div>
