                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    {status === "fundroom_template" && (
                      <span className="px-2 py-0.5 rounded-full text-xs font-semibold bg-emerald-50 text-emerald-700 border border-emerald-200 dark:bg-emerald-950/30 dark:text-emerald-400 dark:border-emerald-800">
                        FundRoom Template
                      </span>
                    )}
                    {status === "custom_uploaded" && (
                      <span className="px-2 py-0.5 rounded-full text-xs font-semibold bg-blue-50 text-blue-700 border border-blue-200 dark:bg-blue-950/30 dark:text-blue-400 dark:border-blue-800">
                        Custom: {customFile || "Uploaded"}
                      </span>
                    )}
                    {status === "not_set" && (
                      <span className="px-2 py-0.5 rounded-full text-xs font-semibold bg-amber-50 text-amber-700 border border-amber-200 dark:bg-amber-950/30 dark:text-amber-400 dark:border-amber-800">
                        Not Set
                      </span>
                    )}
                  </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-700 dark:text-gray-300">
                Allow Investor External Upload
              </p>
              <p className="text-xs text-gray-500">
                Investor uploads docs signed outside the platform.
              </p>
            </div>
            <Switch
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-2 py-0.5 rounded-full text-xs font-semibold bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-400">
                    Coming Soon
                  </span>
                </div>
                <p className="text-xs text-gray-500">
        ...
        <div className="border-t dark:border-gray-700 pt-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">
                Investor submissions go to approval queue before completing onboarding.
              </p>
            </div>
            <Switch
        ...
        <div className="rounded-md border dark:border-gray-700">
          ...
          {gpNotifOpen && (
            <div className="px-3 pb-3 space-y-3 border-t dark:border-gray-700 pt-3">
              ...
              <div className="flex items-center justify-between">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Investor inactive for 72 hours
                </p>
                <Switch
