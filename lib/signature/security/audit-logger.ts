...
export async function logSignatureAudit(data: AuditLogData): Promise<void> {
  try {
    ...
    logger.error("Failed to create signature audit log", { module: "signature-security-audit", error: String(error) });
  }
}
...
export async function logSecurityViolation(
  ...
  logger.warn("Security violation detected", { module: "signature-security-audit", documentId, violation, details });
}
